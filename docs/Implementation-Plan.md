...
[ ] Address Codex review's extension version concern: use build-setting substitutions in the extension plist, inspect the built bundle values, and rerun relevant checks.
