...
| --- | --- | --- | --- | --- |
| 1. Foundation, share, player validation | In PR review | `feat/foundation-share-player` | [#1](https://github.com/joshuawyadao/yarms/pull/1) | Codex and Brooks review, CI Verify, then merge |
