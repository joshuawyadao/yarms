...
| --- | --- | --- | --- | --- |
| 1. Foundation, share, player validation | In PR review | `feat/foundation-share-player` | [#1](https://github.com/joshuawyadao/yarms/pull/1) | Brooks and Codex fixes tested; latest CI Verify, review recheck, then merge |
...
- PR #1 Codex review: the shared Xcode scheme lacked a Run/Profile executable. The generator and checked-in scheme now select the Yarms app, and repository verification checks this invariant. Local tests pass; fresh CI Verify and review recheck remain pending.
