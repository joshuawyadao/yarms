...
5. Compare the workout count and a few notes with the earlier library. Keep the backup until those checks pass. Future shares can use [Save to Yarms directly](Shortcut-Sharing.md) from TikTok's Share Sheet.
